 ...
 */
public abstract class Quintic extends AbstractEasing {
    @Override
    ...
    public static final class In extends Quintic {
        ...
        protected double calculateImpl(final double start, final double distance, double current, final double total) {
            current /= total;
            return distance * current * current * current * current * current + start;
        }
    }
    ...
    public static final class Out extends Quintic {
        ...
        protected double calculateImpl(final double start, final double distance, double current, final double total) {
            current /= total;
            current--;
            return distance * (current * current * current * current * current + 1) + start;
        }
    }
    ...
    public static final class InOut extends Quintic {
        ...
        protected double calculateImpl(final double start, final double distance, double current, final double total) {
            current /= total / 2;
            if (current < 1) {
                return distance / 2 * current * current * current * current * current + start;
            }
            current -= 2;
            return distance / 2 * (current * current * current * current * current + 2) + start;
        }
    }
}